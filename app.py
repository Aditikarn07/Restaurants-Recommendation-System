...
def load():
    ...
    if 'df_percent' not in globals():
        df_percent=pd.read_csv("C:\\Users\\Ankit\\Desktop\\Documents\\Restaurants Recommendation System\\Restaurants Recommendation System\\df_percent.csv")
    ...
    if 'cosine_similarities' not in globals():
        with open("C:\\Users\\Ankit\\Desktop\\Documents\\Restaurants Recommendation System\\Restaurants Recommendation System\\cosine_similarities.pkl",'rb') as f:
...
def recommend(name, cosine_similarities = None):
    ...
    for each in recommend_restaurant:
        df_new = pd.concat([df_new, pd.DataFrame(res_dist[['cuisines','Mean Rating', 'cost']][res_dist.index == each].sample())])
    ...
    for index, row in df_new.iterrows():
        ...
        st.write("Cuisines:", row['cuisines'])
        st.write("Mean Rating:", row['Mean Rating'])
        st.write("Cost:", row['cost'])
